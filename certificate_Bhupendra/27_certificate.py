...
# def create_certificate_image(recipient_name, course_name, issued_by, completed_on, actual_effort, template_path, output_path='certificate_output.png', font_size_large=60, font_size_medium=35, font_size_small=30):
#     # Load certificate template
#     image = Image.open(template_path)
#     draw = ImageDraw.Draw(image)
#     # Set fonts with custom sizes
#     font_large = ImageFont.truetype("georgiab.ttf", font_size_large)
#     font_medium = ImageFont.truetype("georgia.ttf", font_size_large)
#     font_small = ImageFont.truetype("georgia.ttf", font_size_small)

#     # Define positions (x, y) for each field
#     positions = {
#         "recipient_name": (860, 500),
#         "course_name": (850, 725),
#         "issued_by": (240, 900),
#         "completed_on": (860, 900),
#         "actual_effort": (1480, 900)
#     }

#     # Draw text on the image
#     draw.text(positions["recipient_name"], recipient_name, font=font_large, fill="black", anchor="mm")
#     draw.text(positions["course_name"], course_name, font=font_medium, fill="black", anchor="mm")
#     draw.text(positions["issued_by"], issued_by, font=font_small, fill="black", anchor="mm")
#     draw.text(positions["completed_on"], completed_on, font=font_small, fill="black", anchor="mm")
#     draw.text(positions["actual_effort"], actual_effort, font=font_small, fill="black", anchor="mm")
...
#     create_certificate_image(recipient_name, course_name, issued_by, completed_on, actual_effort, template_path)
