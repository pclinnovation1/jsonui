...
user_email = 'piyush@payrollcloudcorp.com'  # Ensure this is the correct UPN
...
def create_event_with_teams_link():
    ...
    # List of attendees
    attendees = [
        {'emailAddress': {'address': 'sajal@payrollcloudcorp.com', 'name': 'Sajal'}, 'type': 'required'},
        {'emailAddress': {'address': 'shreya@payrollcloudcorp.com', 'name': 'Shreya'}, 'type': 'required'},
        {'emailAddress': {'address': 'ankit.pipare@payrollcloudcorp.com', 'name': 'Ankit'}, 'type': 'required'}
    ]
    ...
    data = {
        'subject': 'Test Event with Teams Meeting for Multiple Attendees',
        'body': {
            'contentType': 'HTML',
            'content': 'This is a test event with a Teams meeting link for multiple attendees.'
        },
        'start': {
