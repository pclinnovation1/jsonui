...
#         return evaluate_single_condition(field_value, operator, value)
    
#     elif condition_type in ('all', 'or'):
#         # Nested conditions
#         nested_conditions = condition.get('nestedConditions', [])
#         if condition_type == 'all':
#             return all(evaluate_condition(field_types, field_values, nested) for nested in nested_conditions)
#         elif condition_type == 'or':
#             return any(evaluate_condition(field_types, field_values, nested) for nested in nested_conditions)
