...
openai.api_key = 'sk-proj-H63OwwUg6zwsvTCRyvTbT3BlbkFJkKRjCvNE1PliPFG17cgi'
...
def get_condition_input():
    ...
    return process_id, conditions

def generate_mongodb_format(process_id, conditions):
    condition_strs = []
...
def main():
    process_id, conditions = get_condition_input()
    formatted_conditions = generate_mongodb_format(process_id, conditions)
