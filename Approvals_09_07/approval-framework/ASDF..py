...
# Example usage:
field_types = ['department', 'cost centre']
field_values = ['Product', 'AB0012']

condition = {
    'conditionType': 'all',
    'nestedConditions': [
        {'field': 'department', 'operator': '==', 'value': 'Product'},
        {'field': 'cost centre', 'operator': '==', 'value': 'AB0012'}
    ]
}

approval_rules = {
    '_id': 'ObjectId("668ba6884c472f3bb7bfb370")',
    'processId': 'hghtg54',
    'rules': [
        {'condition': {'field': 'amount', 'operator': '>', 'value': 6800, 'nested': False, 'conditionType': 'na'}, 'approvers': ['auto_approve']},
        {'condition': {'conditionType': 'all', 'nestedConditions': [{'field': 'department', 'operator': '==', 'value': 'Product'}, {'field': 'cost centre', 'operator': '==', 'value': 'AB0012'}]}, 'approvers': ['6683e820527f426df7bcddf4', '6683e87e527f426df7bcddf6']},
        {'condition': {'conditionType': 'or', 'nestedConditions': [{'field': 'department', 'operator': '==', 'value': 'Product'}, {'field': 'cost centre', 'operator': '==', 'value': 'AB0012'}]}, 'approvers': ['6683e820527f426df7bcddf4', '6683e87e527f426df7bcddf6', '66827d04680891d58510dd97']}
    ]
}

result = evaluate_condition(field_types, field_values, condition, approval_rules)
