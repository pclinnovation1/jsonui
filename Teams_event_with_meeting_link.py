...
def create_event_with_teams_link():
    ...
    attendees = [
        ...
        {'emailAddress': {'address': 'prathima@payrollcloudcorp.com', 'name': 'Prathima'}, 'type': 'required'},
        {'emailAddress': {'address': 'deep.kaur@payrollcloudcorp.com', 'name': 'Deep'}, 'type': 'required'}
    ]
