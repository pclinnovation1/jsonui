...
from controllers.payslip_controller import payslip_blueprint
from controllers.salary_controller import salary_blueprint
...
app.register_blueprint(payslip_blueprint, url_prefix='/payslip')
