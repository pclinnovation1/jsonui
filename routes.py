...
def setup_routes(app):
    ...
    #     if not query:
    #         return jsonify({"error": "Employee_Name and Leave_Type are required to identify the leave application"}), 400
    ...
    #             record = collection.find_one({"person_name": employee_name, "leave_type": leave_type})
